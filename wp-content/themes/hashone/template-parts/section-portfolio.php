...
if (get_theme_mod('hashone_disable_portfolio_sec') != 'on') {
    ...
    <section id="hs-portfolio-section" class="hs-section">
        <?php
        $hashone_portfolio_title = get_theme_mod('hashone_portfolio_title', esc_html__('What we do it love', 'hashone'));
        $hashone_portfolio_sub_title = get_theme_mod('hashone_portfolio_sub_title', esc_html__('Check our beautiful works we do', 'hashone'));
        ?>
