...
if (!class_exists('Hashone_Welcome')) :
    ...
    class Hashone_Welcome {
        ...
        public function hashone_activation_admin_notice() {
            ...
            if (is_admin() && ('themes.php' == $pagenow) && (isset($_GET['activated']))) {
                ...
                <div class="notice notice-success is-dismissible"> 
                    <p><?php echo esc_html__('Welcome! Thank you for choosing HashOne. Please make sure you visit Settings Page to get started with HashOne theme.', 'hashone'); ?></p>
                    <p><a class="button button-primary" href="<?php echo admin_url('/themes.php?page=hashone-welcome') ?>"><?php echo esc_html__('Let\'s Get Started', 'hashone'); ?></a></p>
                </div>
                <?php
            }
        }
        ...
        public function hashone_welcome_register_menu() {
            add_theme_page(esc_html__('Welcome', 'hashone'), esc_html__('HashOne Settings', 'hashone'), 'edit_theme_options', 'hashone-welcome', array($this, 'hashone_welcome_screen'));
        }
                    ...
                    <div class="abt-theme-wrap">
                        <h1><?php
                            printf(// WPCS: XSS OK.
                                    ...
                                    esc_html__('Welcome to %1$s - Version %2$s', 'hashone'), $this->theme_name, $this->theme_version);
                            ?></h1>
                        <div class="about-text"><?php echo esc_html__('HashOne is a powerful multipurpose WordPress Theme that is packed with lots of features for creating a full packaged website that can be used by a business, restaurant, freelancers, photographers, bloggers, education firms, non-profit organization and creative agencies. The theme is fully responsive and mobile friendly and has lots of customization possibilities with various home page sections to showcase varieties of content. The theme can be used to set up a single page website with animated content that adds charm to the website with additional parallax effect. The theme is SEO friendly, Translation ready, Woo Commerce compatible and integrates seamlessly with almost all popular WordPress Plugins.', 'hashone'); ?></div>
                    </div>
                </div>
